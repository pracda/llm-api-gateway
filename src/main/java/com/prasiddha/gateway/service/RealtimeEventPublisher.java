...
public class RealtimeEventPublisher {
    ...
    public record AuditEvent(
        ...
        int httpStatus, int jailbreakScore, String ipAddress, String apiKeyId, boolean streamed, String createdAt
    ) {
    ...
    public record AlertEvent(
        ...
        static AlertEvent from(SecurityAlert s) {
            return new AlertEvent(
                s.getId(), s.getUsername(), s.getType().name(), s.getSeverity().name(),
